...
urlpatterns = [ 
    ...
    url(r'^api/farm/plant_data/plant/(?P<pk>[0-9]+)$', views.plant_data_list_plant),
    url(r'^api/farm/plant_data/plant/(?P<pk>[0-9]+)/latest$', views.plant_data_list_plant_latest),
    ...
    url(r'^api/farm/plant_type/name$', views.plant_type_list_name),
    ...
    url(r'^api/farm/plant/name$', views.plant_list_name),
